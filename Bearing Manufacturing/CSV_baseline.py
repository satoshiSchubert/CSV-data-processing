...
#model needs modify
def Model(num_classes, input_shape=(num_param,)):
    model = Sequential()
    model.add(Reshape((num_param, 1), input_shape=input_shape))
    model.add(Conv1D(16, 8,strides=2, activation='relu',input_shape=(num_param,1)))
